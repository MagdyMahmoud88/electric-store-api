...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layout','data' => ['title' => 'إتمام الطلب']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'إتمام الطلب']); ?>
...
<div class="max-w-4xl mx-auto">
  ...
  <div class="grid co-main-grid gap-4 items-start">
    ...
    <div>
      <form method="POST" action="<?php echo e(route('checkout.order')); ?>" id="checkoutForm">
        <?php echo csrf_field(); ?>
        ...
        <div class="card bg-base-100 border border-base-300 shadow-none panel active" id="panel1">
          <div class="card-body p-5">
            ...
            <div class="mb-4">
              ...
              <div class="address-card <?php echo e(isset($defaultAddress) && $defaultAddress?->id === $address->id ? 'selected' : ''); ?>"
                id="addr-card-<?php echo e($address->id); ?>"
                onclick="selectAddress(
                  <?php echo e($address->id); ?>,
                  '<?php echo e(addslashes($address->first_name)); ?>',
                  '<?php echo e(addslashes($address->last_name)); ?>',
                  '<?php echo e(addslashes($address->phone)); ?>',
                  '<?php echo e(addslashes($address->street_address)); ?>',
                  '<?php echo e(addslashes($address->area ?? '')); ?>',
                  '<?php echo e(addslashes($address->city)); ?>',
                  '<?php echo e(addslashes($address->governorate ?? $address->city)); ?>'
                )">
                <input type="radio" name="_address_id" value="<?php echo e($address->id); ?>"
                  <?php echo e(isset($defaultAddress) && $defaultAddress?->id === $address->id ? 'checked' : ''); ?> />
                <div class="flex-1 min-w-0">
                  <div class="flex items-center gap-2 flex-wrap">
                    <p class="text-xs font-semibold"><?php echo e($address->first_name); ?> <?php echo e($address->last_name); ?></p>
                  ...
                  <p class="text-xs text-base-content/50 mt-0.5">
                    <?php echo e($address->street_address); ?><?php if($address->area): ?>, <?php echo e($address->area); ?><?php endif; ?>, <?php echo e($address->city); ?>

                  </p>
                  <p class="text-xs text-base-content/40 mt-0.5"><?php echo e($address->phone); ?></p>
                </div>
              </div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <a href="<?php echo e(route('addresses.index')); ?>" target="_blank"
          ...
          <div class="card-body p-5">
            ...
            <div class="rounded-xl p-3 mb-4 space-y-2"
              ...
              <div class="flex justify-between text-xs">
                ...
                <span><?php echo e(number_format($subtotal, 0)); ?> ج.م</span>
              </div>
              <?php if($discount > 0): ?>
              <div class="flex justify-between text-xs" style="color:#4caf7d;">
                <span>الخصم</span>
                <span>— <?php echo e(number_format($discount, 0)); ?> ج.م</span>
              </div>
              <?php endif; ?>
              <div class="flex justify-between text-xs">
                <span class="text-base-content/50">الشحن</span>
                <span class="<?php echo e($shipping == 0 ? 'text-success' : ''); ?>">
                  <?php echo e($shipping == 0 ? 'مجاني' : number_format($shipping, 0) . ' ج.م'); ?>
              ...
              <div class="flex justify-between text-sm font-bold">
                <span>الإجمالي</span>
                <span style="color:var(--accent)"><?php echo e(number_format($total, 0)); ?> ج.م</span>
              </div>
            </div>
      ...
      <div class="card bg-base-100 border border-base-300 shadow-none overflow-hidden">
        ...
        <div class="p-4 space-y-3 border-b border-base-300">
          ...
          <div class="flex items-center gap-3">
            ...
            <div class="flex-1 min-w-0">
              <p class="text-xs font-semibold truncate"><?php echo e($item['name']); ?></p>
              <p class="text-xs text-base-content/40 mt-0.5">
                <?php if(!empty($item['options'])): ?><?php echo e(implode(' · ', $item['options'])); ?> · <?php endif; ?>
                الكمية: <?php echo e($item['quantity']); ?>
        ...
        <div class="p-4 border-b border-base-300">
          <?php if(session('coupon')): ?>
            <div class="flex items-center gap-2 text-xs py-2 px-3 rounded-lg"
              ...
              <span>كوبون <strong class="mx-1"><?php echo e(session('coupon.code')); ?></strong> — خصم <?php echo e(number_format($discount, 2)); ?> ج.م</span>
            </div>
          <?php else: ?>
            <form action="<?php echo e(route('coupon.apply')); ?>" method="POST" id="couponForm">
              <?php echo csrf_field(); ?>
            ...
            <?php if(session('error') && !session('coupon')): ?>
              <p class="text-xs mt-1" style="color:#e05555;"><?php echo e(session('error')); ?></p>
            <?php endif; ?>
            <?php if(session('success') && !session('coupon')): ?>
              <p class="text-xs mt-1" style="color:#4caf7d;"><?php echo e(session('success')); ?></p>
            <?php endif; ?>
          <?php endif; ?>
        </div>
        ...
        <div class="p-4 space-y-2">
          <div class="flex justify-between text-sm">
            ...
            <span class="font-medium"><?php echo e(number_format($subtotal, 0)); ?> ج.م</span>
          </div>
          <?php if($discount > 0): ?>
          <div class="flex justify-between text-sm">
            <span class="text-base-content/50">الخصم</span>
            <span class="font-medium" style="color:#4caf7d;">— <?php echo e(number_format($discount, 0)); ?> ج.م</span>
          </div>
          <?php endif; ?>
          <div class="flex justify-between text-sm">
            <span class="text-base-content/50">الشحن</span>
            <span class="font-medium <?php echo e($shipping == 0 ? 'text-success' : ''); ?>">
              <?php echo e($shipping == 0 ? 'مجاني' : number_format($shipping, 0) . ' ج.م'); ?>
...
window.addEventListener('DOMContentLoaded', function() {
    selectAddress(
        <?php echo e($defaultAddress->id); ?>,

        '<?php echo e(addslashes($defaultAddress->first_name)); ?>',
        '<?php echo e(addslashes($defaultAddress->last_name)); ?>',
        '<?php echo e(addslashes($defaultAddress->phone)); ?>',
        '<?php echo e(addslashes($defaultAddress->street_address)); ?>',
        '<?php echo e(addslashes($defaultAddress->area ?? '')); ?>',
        '<?php echo e(addslashes($defaultAddress->city)); ?>',
        '<?php echo e(addslashes($defaultAddress->governorate ?? $defaultAddress->city)); ?>'
    );
});
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\USER\Herd\electric-store-api\resources\views/checkout/index.blade.php ENDPATH**/ ?>