...
<head>
    ...
    <title><?php echo e($title ?? 'متجر الكهرباء'); ?></title>
...
<div class="auth-page">
    <div class="auth-wrapper">
        ...
        <div class="auth-brand">
            <a href="<?php echo e(route('welcome')); ?>" style="text-decoration:none;">
        ...
        <p class="auth-footer">&copy; <?php echo e(date('Y')); ?> متجر الكهرباء. جميع الحقوق محفوظة.</p>

    </div>
</div>
</body>
</html>
<?php /**PATH C:\Users\USER\Herd\electric-store-staging\resources\views/components/auth-layout.blade.php ENDPATH**/ ?>