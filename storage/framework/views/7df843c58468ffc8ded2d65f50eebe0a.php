...
<div class="email-container" style="max-width: 600px; margin: 40px auto; background-color: #1e293b; border-radius: 16px; overflow: hidden; border: 1px solid #334155; box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.3);">
    ...
    <div class="content" style="padding: 35px;">
        <p style="font-size: 16px; margin-top: 0;">أهلاً بك يا <strong style="color: #e2b86f; font-weight: 700;"><?php echo e(optional($order->address)->first_name ?? 'عميلنا العزيز'); ?></strong>،</p>
        ...
        <div class="order-badge" style="display: inline-block; background-color: #0f172a; border: 1px solid #334155; padding: 10px 20px; border-radius: 30px; margin: 15px 0 30px 0;">
            ...
            <span style="font-size: 15px; font-weight: 800; color: #e2b86f;">#<?php echo e($order->order_number); ?></span>
        </div>
        ...
        <table class="items-table" style="width: 100%; border-collapse: collapse; margin-bottom: 30px;">
            ...
            <?php $__currentLoopData = $order->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr class="item-row">
                    <td style="text-align: right; padding: 16px; border-bottom: 1px solid #334155; font-size: 13px; font-weight: 600;"><?php echo e($item->name); ?></td>
                    <td style="text-align: center; padding: 16px; border-bottom: 1px solid #334155; font-size: 13px; color: #94a3b8;"><?php echo e($item->quantity); ?></td>
                    <td style="text-align: left; padding: 16px; border-bottom: 1px solid #334155; font-size: 13px; font-weight: 700; color: #e2b86f;"><?php echo e(number_format($item->price * $item->quantity, 0)); ?> ج.م</td>
                </tr>
            ...
            <tr class="summary-row">
                ...
                <td style="text-align: left; padding: 12px 16px 6px 16px; font-size: 13px; color: #f1f5f9; font-weight: 600;"><?php echo e(number_format($order->subtotal, 0)); ?> ج.م</td>
            </tr>

            <tr class="summary-row">
                <td colspan="2" style="text-align: left; padding: 6px 16px; font-size: 13px; color: #94a3b8;">تكلفة الشحن</td>
                <td style="text-align: left; padding: 6px 16px; font-size: 13px; font-weight: 700;" class="<?php echo e($order->shipping == 0 ? 'green-text' : ''); ?>">
                    ...
                    <?php else: ?>
                        <span style="color: #f1f5f9;"><?php echo e(number_format($order->shipping, 0)); ?> ج.م</span>
                    <?php endif; ?>
                </td>
            </tr>

            <tr class="summary-row">
                <td colspan="2" style="text-align: left; padding: 6px 16px 16px 16px; font-size: 13px; color: #94a3b8;">ضريبة القيمة المضافة <?php echo e(number_format(($order->subtotal > 0 ? ($order->tax / $order->subtotal) * 100 : 0), 0)); ?>%</td>
                <td style="text-align: left; padding: 6px 16px 16px 16px; font-size: 13px; color: #f1f5f9; font-weight: 600;"><?php echo e(number_format($order->tax, 0)); ?> ج.م</td>
            </tr>
            ...
            <tr class="total-row">
                ...
                <td style="text-align: left; background-color: #0f172a; padding: 18px 16px; border-radius: 10px 0 0 10px; font-size: 18px; font-weight: 800; color: #e2b86f; border-top: 1px solid #334155; border-bottom: 1px solid #334155;"><?php echo e(number_format($order->total, 0)); ?> ج.م</td>
            </tr>
            </tbody>
        </table>
        ...
        <div class="address-card" style="background-color: #0f172a; border: 1px solid #334155; padding: 20px; border-radius: 12px;">
            <div style="font-weight: 700; color: #e2b86f; font-size: 14px; margin-bottom: 6px;"><?php echo e(optional($order->address)->first_name); ?> <?php echo e(optional($order->address)->last_name); ?></div>
            <div style="font-size: 13px; color: #94a3b8; line-height: 1.6;">
                <span style="color: #64748b;">العنوان:</span> <?php echo e($order->address->street_address); ?><?php if($order->address->building_number): ?>، مبنى <?php echo e($order->address->building_number); ?><?php endif; ?>
                ، <?php echo e($order->address->city); ?>، <?php echo e($order->address->governorate); ?> <br>
                <span style="color: #64748b; display: inline-block; margin-top: 5px;">رقم الهاتف:</span> <?php echo e($order->address->phone); ?>
    ...
    <div class="footer" style="background-color: #0b0f19; padding: 25px; text-align: center; font-size: 12px; color: #475569; border-top: 1px solid #1e293b; line-height: 1.6;">
        ...
        جميع الحقوق محفوظة &copy; <?php echo e(date('Y')); ?> متجر الأدوات الكهربائية الذكي.
    </div>
</div>
</body>
</html>
<?php /**PATH C:\Users\USER\Herd\electric-store-api\resources\views/emails/orders/confirmed.blade.php ENDPATH**/ ?>