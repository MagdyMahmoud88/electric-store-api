...
<div class="min-h-screen flex items-center justify-center p-4"
    ...
    <div style="position:relative;z-index:1;width:100%;max-width:420px;">
        ...
        <div class="flex flex-col items-center gap-3 mb-8">
            <a href="<?php echo e(route('welcome')); ?>" class="flex items-center gap-3" style="text-decoration:none;">
        ...
        <div class="rounded-3xl overflow-hidden"
            ...
            <div class="px-8 pt-8 pb-6 text-center">
                ...
                <p class="text-sm leading-relaxed" style="color:var(--text-muted);">
                    ...
                    <br>
                    <span class="font-black" style="color:var(--electric);"><?php echo e($email); ?></span>
                </p>
            </div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <form action="<?php echo e(route('verification.verify')); ?>" method="POST" id="otp-form">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="flex justify-center gap-3 mb-8 flex-row-reverse" id="otp-container">
                        <?php for($i = 0; $i < 6; $i++): ?>
                        <input class="otp-box <?php $__errorArgs = ['otp'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> otp-error <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>"
        ...
        <div class="text-center mt-6">
            <a href="<?php echo e(route('verification.email')); ?>"
...
<?php endif; ?>
<?php /**PATH C:\Users\USER\Herd\electric-store-staging\resources\views/auth/verify-otp.blade.php ENDPATH**/ ?>