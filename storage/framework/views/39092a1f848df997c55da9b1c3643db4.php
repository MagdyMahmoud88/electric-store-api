...
<div class="container">
    ...
    <div class="body">
        <p>مرحباً <strong><?php echo e($userName); ?></strong>،</p>
    ...
    <div class="footer">
        © <?php echo e(date('Y')); ?> متجر الكهرباء — هذا الإيميل تم إرساله تلقائياً
    </div>
</div>
</body>
</html>
<?php /**PATH C:\Users\USER\Herd\electric-store-api\resources\views/emails/two-factor-code.blade.php ENDPATH**/ ?>