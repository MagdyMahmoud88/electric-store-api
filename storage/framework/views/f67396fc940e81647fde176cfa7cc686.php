                ...
                <div class="step-panel active" id="panel1">
                    ...
                    <div class="field mt-4">
                        ...
                        <div class="brand-grid">
                            ...
                            <div>
                                <input type="radio" name="brand_id" id="brand_none" value=""
                                       class="brand-option"
                                       <?php echo e(old('brand_id', $product->brand_id ?? 'none') == '' ? 'checked' : ''); ?>>
                            ...
                            <div>
                                <input type="radio" name="brand_id" id="brand_<?php echo e($brand->id); ?>"
                                       value="<?php echo e($brand->id); ?>" class="brand-option"
                                       <?php echo e(old('brand_id', $product->brand_id ?? '') == $brand->id ? 'checked' : ''); ?>>
                                <label for="brand_<?php echo e($brand->id); ?>" class="brand-label">
                                    ...
                                    <span class="brand-label-text"><?php echo e($brand->name); ?></span>
                                </label>
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                        ...
                        <p style="font-size:13px;color:var(--text-muted);">
                            لا توجد ماركات —
                            <a href="<?php echo e(route('admin.brands.create')); ?>" style="color:var(--electric);">أضف ماركة الآن</a>
                        </p>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="field mt-4">
                        ...
                        <textarea class="f-textarea" name="description" id="f_desc"
                                  placeholder="اكتب تفاصيل المنتج الفنية هنا..."><?php echo e(old('description', $product->description ?? '')); ?></textarea>
                    </div>
                ...
                <div class="step-panel" id="panel3">
                    ...
                    <div class="step-nav">
                        ...
                        <button type="submit" class="btn btn-submit">
                            ...
                            <?php echo e(isset($product) ? 'حفظ التعديلات' : 'حفظ المنتج في المخزن'); ?>
    ...
    <div>
        <div class="preview-card">
            ...
            <div class="preview-img-wrap" id="previewImgWrap">
                <img id="previewImg" src="<?php echo e(isset($product) && $product->image_url ? asset('storage/'.$product->image_url) : ''); ?>"
                     alt="" style="<?php echo e(isset($product) && $product->image_url ? '' : 'display:none'); ?>" />
                <div class="no-img" id="noImgPlaceholder" style="<?php echo e(isset($product) && $product->image_url ? 'display:none' : ''); ?>">
            ...
            <div class="preview-body">
                <div class="preview-name" id="pName"><?php echo e($product->name ?? 'اسم المنتج'); ?></div>
                <div class="preview-meta">
                    <div class="preview-cat" id="pCat"><?php echo e($product->category->name ?? 'القسم'); ?></div>
                    <div class="preview-brand" id="pBrand" style="<?php echo e(isset($product) && $product->brand ? '' : 'display:none'); ?>">
                        <?php echo e($product->brand->name ?? ''); ?>

                    </div>
                </div>
                <div class="preview-desc" id="pDesc"><?php echo e($product->description ?? 'سيظهر الوصف هنا...'); ?></div>
                <div class="preview-price-row">
                    <div class="preview-price" id="pPrice"><?php echo e(isset($product) ? number_format($product->price, 2).' EGP' : '—'); ?></div>
                ...
                <div class="preview-stock" id="pStock" style="<?php echo e(isset($product) && $product->stock > 0 ? '' : 'display:none'); ?>">
                    <div class="stock-dot"></div>
                    <span id="pStockText"><?php echo e(isset($product) ? $product->stock.' وحدة متوفرة' : ''); ?></span>
                </div>
            </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\USER\Herd\electric-store-api\resources\views/admin/products/create.blade.php ENDPATH**/ ?>