...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.auth-layout','data' => ['title' => 'التحقق بخطوتين']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'التحقق بخطوتين']); ?>
    ...
    <div class="auth-card">
        ...
        <form action="<?php echo e(route('2fa.verify')); ?>" method="POST" id="twoFaForm">
            <?php echo csrf_field(); ?>
        ...
        <div style="text-align:center;margin-bottom:16px;">
            ...
            <form action="<?php echo e(route('2fa.send')); ?>" method="POST" style="display:inline;">
                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\USER\Herd\electric-store-api\resources\views/auth/two-factor.blade.php ENDPATH**/ ?>