...
<div class="page-container py-10">
    ...
    <div class="flex items-center justify-between mb-8">
        <div>
            ...
            <p class="text-sm mt-1" style="color:var(--text-muted)"><?php echo e($product->name); ?></p>
        </div>
            ...
            <form action="<?php echo e(route('admin.products.update', $product->id)); ?>"
                    ...
                    <div class="card-body gap-5">
                        ...
                        <div class="form-control gap-1">
                            ...
                            <textarea name="description"
                                      ...
                                      style="background:var(--surface2);border-color:var(--border);color:var(--text);resize:vertical;"><?php echo e(old('description', $product->description)); ?></textarea>
                        </div>
                            ...
                            <div class="form-control gap-1">
                                ...
                                <label class="input input-bordered flex items-center gap-2 w-full"
                                    ...
                                    <input type="number"
                                           ...
                                           class="grow"
                                           style="background:transparent;outline:none;color:var(--text);"
                                           value="<?php echo e(old('discount_percentage', $product->discount_percentage ?? 0)); ?>">
                                </label>
                            </div>
                        </div>
                ...
                <div class="flex items-center justify-between flex-wrap gap-3">
                    ...
                    <div class="flex gap-3">
                        <a href="<?php echo e(route('admin.dashboard')); ?>" class="btn btn-ghost btn-sm">إلغاء</a>
        ...
        <div class="lg:col-span-1">
            <div class="card sticky top-24 overflow-hidden"
                ...
                <div class="h-52 flex items-center justify-center overflow-hidden"
                    ...
                    <img id="previewImg"
                         src="<?php echo e($product->image_url ? asset('storage/' . $product->image_url) : ''); ?>"
                         class="w-full h-full object-contain"
                         style="<?php echo e($product->image_url ? '' : 'display:none'); ?>"
                         alt="">
                ...
                <div class="p-5 space-y-3">
                    <h3 id="pName" class="text-lg font-black" style="color:var(--text);"><?php echo e($product->name); ?></h3>

                    <div id="pCat"
                         class="inline-flex items-center gap-2 text-xs"
                         style="color:var(--text-muted);">
                        <span class="w-1.5 h-1.5 rounded-full inline-block" style="background:var(--electric);"></span>
                        <?php echo e($product->category->name ?? 'القسم'); ?>

                    </div>

                    <p id="pDesc" class="text-xs leading-relaxed" style="color:var(--text-soft);"><?php echo e($product->description); ?></p>

                    <div class="flex items-baseline gap-2 flex-wrap">
                        <span id="pPrice" class="text-2xl font-black" style="color:var(--electric);">
                            <?php echo e(number_format($product->final_price, 2)); ?> EGP
                        </span>
                    ...
                    <div id="pStock"
                         ...
                         style="<?php echo e($product->stock > 0 ? '' : 'display:none'); ?>;color:var(--text-soft);">
                        <span class="w-2 h-2 rounded-full" style="background:var(--success);"></span>
                        <span id="pStockText"><?php echo e($product->stock); ?> وحدة متوفرة</span>
                    </div>
                </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\USER\Herd\electric-store-api\resources\views/admin/products/edit.blade.php ENDPATH**/ ?>