    ...
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 pb-12">
            ...
            <div class="lg:col-span-1">
                <a href="<?php echo e(route('welcome')); ?>" class="flex items-center gap-2 mb-4 no-underline">
            ...
            <div>
                ...
                <ul class="flex flex-col gap-2.5">
                    <li>
                        <a href="<?php echo e(route('welcome')); ?>" class="text-sm text-base-content/50 hover:text-warning transition-colors no-underline">
                            الرئيسية
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('products.index')); ?>" class="text-sm text-base-content/50 hover:text-warning transition-colors no-underline">
                            جميع المنتجات
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('cart.index')); ?>" class="text-sm text-base-content/50 hover:text-warning transition-colors no-underline">
                            سلة المشتريات
                        </a>
                    </li>
                    <?php if(auth()->guard()->guest()): ?>
                    <li>
                        <a href="<?php echo e(route('register.index')); ?>" class="text-sm text-base-content/50 hover:text-warning transition-colors no-underline">
                            إنشاء حساب
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('login')); ?>" class="text-sm text-base-content/50 hover:text-warning transition-colors no-underline">
                            تسجيل الدخول
                        </a>
                    </li>
                    <?php endif; ?>
        ...
        <div class="border-t border-base-content/10 py-5 flex flex-col sm:flex-row items-center justify-between gap-3 flex-wrap">
            <p class="text-xs text-base-content/35">
                © <?php echo e(date('Y')); ?> متجر <span class="text-warning">الكهرباء</span> — جميع الحقوق محفوظة
            </p>
...
<?php /**PATH C:\Users\USER\Herd\electric-store-staging\resources\views/components/footer.blade.php ENDPATH**/ ?>