...
<head>
    ...
    <meta name="description" content="{{ $description ?? 'متجر إلكتروني شامل للأدوات الكهربائية' }}">
    ...
    {{-- ✅ هنا بييجي أي CSS خاص بكل صفحة (زي cart, checkout...) --}}
    @stack('kashier')
...
<x-nav-bar />
    ...
    {{-- ✅ scripts الـ components (wishlist, cart, checkout...) --}}
    @stack('scripts')
