        ...
        <div class="bg-base-200 border-b border-base-300 pt-10 pb-16 px-4">
            <div class="max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-6">
                ...
                <div class="flex-1 text-center md:text-right">
                    <h1 class="text-2xl font-bold text-base-content mb-1">{{ auth()->user()->name }}</h1>
                    <p class="text-base-content/50 text-sm mb-3">{{ auth()->user()->email }}</p>
                ...
                <a href="{{ route('orders.index') }}"
                   class="group bg-base-100 border border-base-300 hover:border-primary/40 rounded-2xl p-4 flex items-center gap-3 transition-colors duration-200">
                    ...
                    <div>
                        ...
                        <div class="text-xl font-bold text-base-content">{{ auth()->user()->orders()->count() }}</div>
                    </div>
                </a>
                ...
                <a href="{{ route('wishlist.index') }}"
                   class="group bg-base-100 border border-base-300 hover:border-secondary/40 rounded-2xl p-4 flex items-center gap-3 transition-colors duration-200">
                    ...
                    <div>
                        ...
                        <div class="text-xl font-bold text-base-content">{{ auth()->user()->wishlists()->count() }}</div>
                    </div>
                </a>
                ...
                <a href="{{ route('profile.reviews') }}"
                   class="group bg-base-100 border border-base-300 hover:border-accent/40 rounded-2xl p-4 flex items-center gap-3 transition-colors duration-200">
                    ...
                    <div>
                        ...
                        <div class="text-xl font-bold text-base-content">{{ auth()->user()->reviews()->count() }}</div>
                    </div>
                </a>
                        ...
                        <form action="{{ route('profile.update') }}" method="POST">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-6">
                                ...
                                <div>
                                    ...
                                    @error('name') <p class="text-error text-xs mt-1.5">{{ $message }}</p> @enderror
                                </div>
                    ...
                    <div id="panel-password" class="tab-panel hidden">
                        ...
                        <form action="{{ route('profile.password') }}" method="POST" class="max-w-md space-y-4">
                            ...
                            <div>
                                ...
                                @error('current_password') <p class="text-error text-xs mt-1.5">{{ $message }}</p> @enderror
                            </div>
